...
User.create(username: "Tun", email: "tun@tuntun.com", password: "123")
User.create(username: "Will", email: "will@tuntun.com", password: "123")
User.create(username: "Tiffani", email: "tun@tuntun.com", password: "123")
User.create(username: "Brit", email: "Brit@tuntun.com", password: "123")
User.create(username: "Hanaa", email: "hanaa@tuntun.com", password: "123")
User.create(username: "Andrew", email: "andrew@tuntun.com", password: "123")
User.create(username: "Scott", email: "scott@tuntun.com", password: "123")
User.create(username: "Preston", email: "preston@tuntun.com", password: "123")
User.create(username: "Paula", email: "paula@tuntun.com", password: "123")
User.create(username: "Rose", email: "rose@tuntun.com", password: "123")
User.create(username: "Evan", email: "evan@tuntun.com", password: "123")
User.create(username: "Han", email: "han@tuntun.com", password: "123")
User.create(username: "Deka", email: "deka@tuntun.com", password: "123")
User.create(username: "Romy", email: "romy@tuntun.com", password: "123")
User.create(username: "Bill Gates", email: "billg@tuntun.com", password: "123")
User.create(username: "Elon Musk", email: "elon@tuntun.com", password: "123")
User.create(username: "Evan", email: "evan@tuntun.com", password: "123")




Comment.create(text: "Wow so cute!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Wow so cute!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Wow so cute!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Wow so cute!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Wow so cute!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
...
Comment.create(text: "Wow so cute!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Wow so cute!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Shoe eater",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Shoe eater",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Shoe eater",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Shoe eater",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Shoe eater",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
...
Comment.create(text: "Wow so cute!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Shoe eater",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "This pet is amazing!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "This pet is amazing!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Wow so cute!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Wow so cute!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "This animal scares me",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "This animal scares me",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "In love",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Big boi!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Big boi!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "I need this pet in my life!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "I need this pet in my life!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "I need this pet in my life!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "I need this pet in my life!",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "I met this one before. Attitude problems for sure",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "I met this one before. Attitude problems for sure",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Will eat your couch",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Garbage lover",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Chews everything",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Garbage lover",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Garbage lover",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Real biter",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Garbage lover",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Real biter",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Real biter",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Comment.create(text: "Real biter",user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
...
Like.create(user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Like.create(user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Like.create(user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Like.create(user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
Like.create(user_id: User.all.sample.id, pet_id: Pet.all.sample.id)
